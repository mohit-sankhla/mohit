...
def main():
   ...
   <center><p style="font-size:25px;color:white;margin-top:10px;">Experiment Deployment By Mohit Sankhla</p></center> 
   </div>
   </div>
   </div>
   """
    ...
    if st.button("About"):
      st.subheader("Developed by Mohit Sankhla")
